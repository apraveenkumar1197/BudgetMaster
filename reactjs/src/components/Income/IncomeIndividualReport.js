    ...
    return <Grid
        ...
        <Table flex={1}>
            <TableHead style={{backgroundColor: '#1976d2'}}>
                <TableRow><TableCell>S.No</TableCell><TableCell>Reason</TableCell><TableCell>Date</TableCell><TableCell>Category</TableCell><TableCell>Sub
                    category</TableCell><TableCell>Amount</TableCell><TableCell>Pay mode</TableCell></TableRow>
            </TableHead>
            <TableBody>
                <TableRow><TableCell></TableCell><TableCell></TableCell><TableCell></TableCell><TableCell></TableCell><TableCell></TableCell><TableCell><b>{formatter.format(incomeListTotal)} ({incomeList.length})</b></TableCell><TableCell></TableCell></TableRow>
                {incomeList.map((income, i) => (
                    <TableRow><TableCell>{i + 1}</TableCell><TableCell>{income.reason.name}</TableCell><TableCell>{income.date}</TableCell><TableCell>{income.category == null ? '' : income.category.name}</TableCell><TableCell>{income.subCategory == null ? '' :  income.subCategory.name}</TableCell><TableCell>{formatter.format(income.amount)}</TableCell><TableCell>{income.payMode.name}</TableCell></TableRow>
                ))}
            </TableBody>
            <TableFooter>
